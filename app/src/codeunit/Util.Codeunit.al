codeunit 82560 "BC2ASB Util"
{
    ...
    procedure ConvertFieldToText(MessageFieldSetup: Record "BC2ASB Message Field Setup"; FieldRef: FieldRef): Text
    var
    ...
    begin
        case FieldRef.Type of
            ...
            FieldRef.Type::Option:
                if MessageFieldSetup."Export Enum as Integer" then
